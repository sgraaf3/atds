        ...
        container.innerHTML = `
            <div class="honour-page" style="padding: 20px; line-height: 1.6; max-width: 900px; margin: 0 auto;">
                <header style="border-bottom: 2px solid #2c3e50; padding-bottom: 15px; margin-bottom: 25px; text-align: center;">
                    <h1 style="color: var(--primary); margin-bottom: 5px;" data-i18n="honouringStans">${i18n.translate('honouringStans')}</h1>
                    <p style="color: #7f8c8d; font-style: italic;">Pioneer in Lung Function and Exercise Physiology</p>
                </header>
                ...
                <section style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 30px;">
                    <div style="background: #f8f9fa; padding: 20px; border-radius: 8px;">
                        ...
                        <h4 style="margin-top: 20px;">Courses:</h4>
                        <ul style="list-style-type: disc; padding-left: 20px;">
                            ${Object.entries(this.academyLinks).map(([name, url]) =>
                                `<li><a href="${url}" target="_blank" style="color: #2c3e50; text-decoration: none;">${name}</a></li>`).join('')}
                        </ul>
                    </div>
